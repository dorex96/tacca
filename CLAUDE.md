...
- **il tap non passa dal motore Dart** — l'App Intent gira nel processo dell'estensione, il broadcast Android può arrivare a processo ucciso: entrambi scrivono in una coda durabile (App Group `UserDefaults` di là, file JSON di qua) e l'app la drena al rientro in foreground;
