...
android {
    namespace = "com.tverdohleb.tacca"
    ...
    compileOptions {
        ...
        // Richiesto da flutter_local_notifications (>=10) per le notifiche
        // programmate con retrocompatibilità.
    ...
    defaultConfig {
        ...
        applicationId = "com.tverdohleb.tacca"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // Target minimo dichiarato nell'analisi tecnica (§1): Android 8.0.
        minSdk = 26
